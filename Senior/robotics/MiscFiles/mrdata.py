...
def botPositionEventCallback( botPositionMessage ):
    ...
    if ( not useOdometryForLocalization ):
        ...
        targetPositionMessage = botPositionMessage[0]
...
def initializeCommands( myBotName, otherBotName, masterBot ):
    ...
    rospy.init_node( 'MrDataMover', anonymous=True )
    ...
    rospy.Subscriber( "/" + myBotName + "_base/events/bumper", BumperEvent, bumperEventCallback )
