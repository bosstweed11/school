...
void setup_BASS()
{
  ...
  if (!BASS_Init(-1,44100,0,0,NULL))
    ...
    sounds[0] = BASS_StreamCreateFile(FALSE, "./sound/boom1.wav", 0, 0, 0);
    sounds[1] = BASS_StreamCreateFile(FALSE, "./sound/boom2.wav", 0, 0, 0);
    sounds[2] = BASS_StreamCreateFile(FALSE, "./sound/boom3.wav", 0, 0, 0);
    sounds[3] = BASS_StreamCreateFile(FALSE, "./sound/boom4.wav", 0, 0, 0);
    sounds[4] = BASS_StreamCreateFile(FALSE, "./sound/boom5.wav", 0, 0, 0);
    sounds[5] = BASS_StreamCreateFile(FALSE, "./sound/boom6.wav", 0, 0, 0);
    sounds[6] = BASS_StreamCreateFile(FALSE, "./sound/boom7.wav", 0, 0, 0);
    sounds[7] = BASS_StreamCreateFile(FALSE, "./sound/boom8.wav", 0, 0, 0);
    sounds[8] = BASS_StreamCreateFile(FALSE, "./sound/boom9.wav", 0, 0, 0);
    sounds[9] = BASS_StreamCreateFile(FALSE, "./sound/boom10.wav", 0, 0, 0);
    sounds[10] = BASS_StreamCreateFile(FALSE, "./sound/boom11.wav", 0, 0, 0);
    sounds[11] = BASS_StreamCreateFile(FALSE, "./sound/boom12.wav", 0, 0, 0);
    sounds[12] = BASS_StreamCreateFile(FALSE, "./sound/boom13.wav", 0, 0, 0);
    sounds[13] = BASS_StreamCreateFile(FALSE, "./sound/boom14.wav", 0, 0, 0);
}
...
void make_explosion(EXPLOSION *po, GLfloat radius, GLfloat density, 
  ...
  start_y +=(float)((rand() % (3)) - 1)/10.;
  start_x +=(float)((rand() % (3)) - 1)/100.;
    ...
    for (i = 0; i < (&explosions[j])->quantity; i++) {
      ...
      if (cur_explosion->counter < cur_explosion->radius) {
        ...
        if (cur_explosion->counter > cur_explosion->radius && cur_explosion->counter < cur_explosion->radius + cur_explosion->after_counter && cur_explosion -> radius > 0) {
          ...
          cur->init_color[0]=cur->init_color[0]-500*fall_time;
          cur->init_color[1]=cur->init_color[1]-500*fall_time;
          cur->init_color[2]=cur->init_color[2]-500*fall_time;
