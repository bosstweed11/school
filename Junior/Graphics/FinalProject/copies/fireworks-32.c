...
{ 
  ...
  case 'R': {
  		...
  		BASS_ChannelPlay(sounds[21], TRUE);
  ...
  case 'T': {
  		...
  		//sparkler out of 4
  		BASS_ChannelPlay(sounds[22], TRUE);
  ...
  case 'Y': {
  		...
  		//sparkler out of 5
  		BASS_ChannelPlay(sounds[23], TRUE);
  ...
  case 'U': {
  		...
  		//sparkler out of 6
  		BASS_ChannelPlay(sounds[24], TRUE);
...
void setup_BASS()
{
  ...
  if (!BASS_Init(-1,44100,0,0,NULL))
    ...
    sounds[16] = BASS_StreamCreateFile(FALSE, "./sound/OOT.wav", 0, 0, 0);
    sounds[17] = BASS_StreamCreateFile(FALSE, "./sound/1-up.wav", 0, 0, 0);
    sounds[18] = BASS_StreamCreateFile(FALSE, "./sound/smb_powerup.wav", 0, 0, 0);
    sounds[19] = BASS_StreamCreateFile(FALSE, "./sound/sizzle1.mp3", 0, 0, 0);
    sounds[20] = BASS_StreamCreateFile(FALSE, "./sound/sizzle1.mp3", 0, 0, 0);
    sounds[21] = BASS_StreamCreateFile(FALSE, "./sound/sizzle1.mp3", 0, 0, 0);
    sounds[22] = BASS_StreamCreateFile(FALSE, "./sound/sizzle1.mp3", 0, 0, 0);
    sounds[23] = BASS_StreamCreateFile(FALSE, "./sound/sizzle1.mp3", 0, 0, 0);
    sounds[24] = BASS_StreamCreateFile(FALSE, "./sound/sizzle1.mp3", 0, 0, 0);
    sounds[25] = BASS_StreamCreateFile(FALSE, "./sound/sizzle1.mp3", 0, 0, 0);
