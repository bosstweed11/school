...
#define NUM_NOZZLES 5
#ifndef M_PI //In VS 2010 M_PI seems to be missing, so we will put it here
#define M_PI 3.14159265
#endif

#define	RS 10		// these will be our tesselation factors
#define VS 10		// for RS and VS. Something relatively small
...
typedef struct _Firework {
	...
	short nozzle_id;					// which nozzle it comes out of (probably not necessary)
	FUSE fuse;						// the fuse!
	EXPLOSION explosion;	// the explosion!

}FIREWORK;

// nozzle struct for launch point of firework
