...
<html>
 ...
 <?php
      ...
      mysql_query("drop table Corvettes"); 
      mysql_query("drop table States");
      mysql_query("drop table Equipment");
      mysql_query("drop table Corvettes_Equipment");
      ...
      $result = mysql_query(
                "create table Corvettes (Vette_id int primary key not null, Body_Style char(30) not null, Miles float(5,1) not null, Year char(4) not null, State int not null)") or die ("Invalid: " . mysql_error());
      ...
      $result = mysql_query(
                "create table States (State_id int primary key not null, State char(30) not null)") or die ("Invalid: " . mysql_error());
      ...
      $result = mysql_query(
                "create table Equipment (Equip_id int primary key not null, Equip char(30) not null)") or die ("Invalid: " . mysql_error());
      ...
      $result = mysql_query(
                "create table Corvettes_Equipment(Vette_id int not null, Equip int not null)") or die ("Invalid: " . mysql_error());
      ...
      foreach ($tables as $curr_table=>$curr_keys):
         ...
         $result = mysql_query($query);  #Eval and store result
         $rows = mysql_num_rows($result); #Det. num. of rows
         $keys = $curr_keys;
?>
      <table border = "1">
