	...
	private class ButtonHandler implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
            ...
            else if (e.getSource() == save)
            {
				...
				if(file ==null)
					JOptionPane.showMessageDialog(null,"Going back to previous picture.");
				else
            		drawPanel.savePage(file);
			...
			else if(e.getSource() == open)
			{
				if(saveshape!=numshape)
				{
					...
					if(change==JOptionPane.YES_OPTION)
					{
						file = JOptionPane.showInputDialog("Enter the name of the file you would like to save to:");
							if(file ==null)
								JOptionPane.showMessageDialog(null,"Clearing page and not saving.");
							else
            					drawPanel.savePage(file);
			...
			else if (e.getSource() == endProgram)
			{
				...
				if(file == null&&numshape>0 || saveshape!=numshape)
				{
					...
					if(option==JOptionPane.YES_OPTION)
					{
						...
						file = JOptionPane.showInputDialog("Enter the name of the file you would like to save to:");
						if(file ==null)
							JOptionPane.showMessageDialog(null,"File not saved, ending program.");
						else
						{
            				drawPanel.savePage(file);
