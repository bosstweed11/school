...
randomy:
	li $a1,7			#change random high value to 7 then redo random values
	la $t1, green_y
	j random
...
_setGreen:
	...
	lw $a1,($t1)		
	lw $a2,($t2)
	beq $a0,-1,skip	# if this green has been found, make black
